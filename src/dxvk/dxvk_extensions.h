...
namespace dxvk {
  ...
  struct DxvkDeviceExtensions {
    ...
    DxvkExt extDebugMarker                    = { VK_EXT_DEBUG_MARKER_EXTENSION_NAME,                       DxvkExtMode::Optional };
    ...
    DxvkExt khrExternalMemory                 = { VK_KHR_EXTERNAL_MEMORY_EXTENSION_NAME,                    DxvkExtMode::Required };
    DxvkExt khrExternalMemoryWin32            = { VK_KHR_EXTERNAL_MEMORY_WIN32_EXTENSION_NAME,              DxvkExtMode::Required };
    DxvkExt khrExternalSemaphore              = { VK_KHR_EXTERNAL_SEMAPHORE_EXTENSION_NAME,                 DxvkExtMode::Required };
    DxvkExt khrExternalSemaphoreWin32         = { VK_KHR_EXTERNAL_SEMAPHORE_WIN32_EXTENSION_NAME,           DxvkExtMode::Required };
    ...
    DxvkExt khrWin32KeyedMutex                = { VK_KHR_WIN32_KEYED_MUTEX_EXTENSION_NAME,                  DxvkExtMode::Required };
